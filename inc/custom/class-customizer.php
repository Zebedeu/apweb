<?php
	...
	$wp_customize->add_section('faq_sec', array(
		'title' => __('FAQ', 'apweb'),
		'description' => __('Frequently Asked Questions about the site', 'apweb'),
		'priority' => null
	));

	$wp_customize->add_setting('faq_title', array(
		'default'=> __('Add your question here', 'apweb'),
		'sanitize_callback' => 'sanitize_text_field'
	));


	$wp_customize->add_control('faq_title', array(
		'label' => __('Questions', 'apweb'),
		'setting' => 'faq_title',
		'section' => 'faq_sec'
	));
	$wp_customize->add_setting('faq_desc', array(
		'default' => __( 'Add the answer here', 'apweb'),
	...
	$wp_customize->add_control(
		new WP_Customize_Textarea_Control(
			...
			'faq_desc',
			array(
				'input' => __('ADD YOU FAQ QUESTION HERE', 'apweb'),
				'setting' =>'faq_desc',
				'section' => 'faq_sec'
			)
		)
